                    ...
                    if chromatizeButton then
                        ...
                        if billboardGui then
                            ...
                            if priceLabel and priceLabel.Text then
                                ...
                                print("[DEBUG] Price text found: " .. tostring(text))
                                -- Extract number from text like "5e178 PRISMS"
                                local numberStr = text:match("([%d%.e%-+]+)%s*PRISMS")
                                if numberStr then
                                    -- Remove + sign from scientific notation (e.g., "5e+178" -> "5e178")
                                    numberStr = numberStr:gsub("e%+", "e")
